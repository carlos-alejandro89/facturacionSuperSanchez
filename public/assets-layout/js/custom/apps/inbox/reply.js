    ...
    const e = e => {
        ...
        t = e => {
            ...
            t.addEventListener("click", (function() {
                t.setAttribute("data-kt-indicator", "on"), setTimeout((function() {
                    ...
                    var formData = new FormData(document.getElementById("kt_inbox_reply_form"));
                    
                    $.ajax({
                        url:'/cfdi/support/sendmessage',
                        type:'post',
                        data: formData,
                        processData: false,  
                        contentType: false,
        ...
        a = e => {
            var t, a = new Tagify(e, {
                ...
                whitelist: [{
                    value: 1,
                    name: "Soporte Sánchez",
                    avatar: "avatars/tia-sanchez.png",
                    email: "soporte@sanchezgrupo.com"
                }]
            });
        ...
        n = e => {
            ...
            quill.on('text-change', function (delta) {
                ...
                $("#txtMessage").val(change.ops[0]['insert']);
            });

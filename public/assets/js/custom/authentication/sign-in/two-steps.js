        ...
        init: function() {
            ...
            e = document.querySelector("#kt_sing_in_two_steps_form"), (t = document.querySelector("#kt_sing_in_two_steps_submit")).addEventListener("click", (function(n) {
                ...
                o.map((function(e) {
                    ...
                    var formData = new FormData(document.getElementById("kt_sing_in_two_steps_form"));
                    $.ajax({
                        url:'/accounts/sign-validate',
                            type:'post',
                            data: formData,
                            processData: false,  
                            contentType: false,
                    ...
                    text: "Por favor, introduce los 6 digitos de tu firma.",
                    icon: "warning",
                    buttonsStyling: !1,

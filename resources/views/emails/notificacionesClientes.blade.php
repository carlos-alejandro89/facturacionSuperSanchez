  ...
  <body id="kt_body" class="app-blank">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
      ...
      <div class="d-flex flex-column flex-column-fluid">
        <div class="bg-body d-flex flex-column-auto justify-content-cenrer align-items-start gap-2 gap-lg-4 py-4 px-10 overflow-auto"></div>
        <!--begin::Body-->
        <div class="scroll-y flex-column-fluid px-10 py-10" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true" style="background-color:#D5D9E2; --kt-scrollbar-color: #d9d0cc; --kt-scrollbar-hover-color: #d9d0cc">
                ...
                <tbody>
                    ...
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                      ...
                      <div style="text-align:center; margin:0 60px 34px 60px">
                        ...
                        <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                          <p style="margin-bottom:5px; color:#181C32; font-size: 22px; font-weight:700">¡Hemos atendido su solicitud!</p>
                          <p style="margin-bottom:2px; color:#7E8299">Gracias por utilizar nuestro servicio de facturación electrónica. </p>
                        </div>
                        <!--end:Text-->
                        <div style="text-align:start; font-size: 13px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                          <p style="margin-bottom:1px; color:#181C32; font-size: 18px; font-weight:600">{{$facturacion->razon_social}},</p>
                          <p style="margin-bottom:2px; color:#5E6278">Apreciable cliente, lamentamos comunicarle que su solicitud ha sido declinada</p>
                          <p style="margin-bottom:2px; color:#5E6278">{{$asunto}}
                            <span style="color:#181C32;font-weight:600">{{$motivo->detalle_motivo}}.</span>
                          </p>
                        ...
                        <!--begin:Action-->
                        <a href="{{route('consulta-cfdi')}}" target="_blank" style="text-decoration:none;background-color:#004A9A; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;"> Solicitar ayuda </a>
                        <!--end:Action-->
                      </div>
                      <!--end:Email content-->
                    </td>
                  ...
                  <tr style="display: flex; justify-content: center; margin:0 60px 35px 60px">
                    <td align="start" valign="start" style="padding-bottom: 10px;">
                      <p style="color:#181C32; font-size: 18px; font-weight: 600; margin-bottom:13px">Estos son los datos que nos proporcionó</p>
                      <!--begin::Wrapper-->

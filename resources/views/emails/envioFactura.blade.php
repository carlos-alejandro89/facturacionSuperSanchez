    ...
    <div style="margin-bottom:55px; text-align:left">
        ...
        <div style="font-size:14px; text-align:left; font-weight:500; margin:0 60px 33px 60px; font-family:Arial,Helvetica,sans-serif">
            ...
            <p style="color:#3F4254; line-height:1.6">
                Su solicitud fue procesada con exito, y como parte del servicio de emisión CFDI v4.0, adjuntamos los archivos XML y PDF de su factura. No responda a este mensaje. Este correo electrónico fue enviado por un sistema automático que no controla las respuestas.
            </p> 
